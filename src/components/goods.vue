<template>
  <div id="goods">
    <div class="menu-wrapper" ref="menuWrapper"> <!--加了ref之后，可以通过$refs获取dom-->
    ...
    <div class="foods-wrapper" ref="foodsWrapper">
      <ul>
        <li v-for="(items,index) in goods" :key="index" class="foods-list-hook">
          <div class="items-title">{{items.name}}</div> <!-- 这里的items必须和上面的item命名不同 -->
          <ul>
...
/****************************由于有多行文本，所以不能直接用line-height=heigth，多行文本居中,text-wrapper类=》，将display:table-cell设为表格********************************/
</script>
